...
if(isset($_GET['book_to_return'])&& isset($_GET['user_to_return'])){
	...
	<div class="indexcont_container">
			<div class="head">
				<span class="searchBoxHOLDER">
						<input type="text" name="" placeholder="Borrower Id" id="searchBox">
		...
		<div class="left_Dashboard">
      		<div class=""><a href="index.php"><img src="arrow.png"/></a></div>
						<a href="#"><div class="dashboardBox">
							&nbsp;&nbsp;Book return
							<span class="counter"><?php echo $database->getCountAllBorrowedBook(); ?></span></div>
            </a>
		...
		<div id="content_col">
			<h3 id="heading">Book return</h3>
			<hr id="hrzLine">
            <div id="shelfLabels">
			<table id="titleHead" border="1">
				<tr>
					<td  align="center" width="25%">Name</td>
					<td width="45%">Book title</td>
					<td width="20%">Rerutn date</td>
					<td width="5%">Exceed?</td>
			...
			<table id="bookshelf" width="100%">
			    ...
			    <?php
			        ...
			        $exceed="no";
			         ...
			         foreach($database->getAllBorrowedToReturn() as $books){
			                echo "<tr>";
			                echo "<td width='25%'>".$books['user_name']."</td>";
		                    echo "<td width='45%'>".$books['title']."</td>";
		                    echo "<td width='15%'>".$books['dayto']."</td>";
		                    echo "<td  width='15%' align='center'>".$exceed."</td>";		                   
		                    echo "<td><center><a 
		                    id='borrow' 
		                    href='bookreturn.php?book_to_return=".$books['id'].'&&user_to_return='.$books['user_id']."'>Return</a></center></td>";
		                    echo"</tr>";
			         }
