...
#shelfLabels{
	...
	line-height: 20px;
	background-color:rgba(0,0,0,.5);/*#5C6489;/*#7184C2;/#1B364A *#FD7056;/*#2F5D84;*/
	filter: drop-shadow( 1px 30px 10px rgba(0,0,0,.25));
	margin:0px 0 0 0px;
	font-family: monospace;
	color:#fff;
}
  ...
  <span class="backIcon"><a href="index.php"><img src="book.png"/></a></span>
	...
	<div class="indexcont_container">
			<div class="head">
				...
				<span class="logoutSection"><a href="librarianIndex.php">&nbsp;Back&nbsp;</a></span>
			</div>
		...
		<div id="content_col">
			<h3 id="heading">Books Borrowed</h3>
			<hr id="hrzLine">
      <div id="shelfLabels">
  			<table id="titleHead">
  				<tr>
